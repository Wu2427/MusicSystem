		...
		<div class="agileinfo-header">
			<div class="container">
				...
				<div class="agileits-w3layouts-icons">
					...
					<a href="jsp/admin/adminindex.jsp"><i class="glyphicon glyphicon-user"></i></a>
					</div> 
				</div>
		...
		<div class="container" style="margin-top: -90px;">
			<div class="about-info">
				<div style="margin-left: 300px;height: 450px;" class="col-md-5">
					<h4 style="margin-left: 200px;">Signup</h4>
					<br /><br>
					<form action="<%=basePath%>user/addUser" class="bs-example bs-example-form" role="form">
						...
						<br>
							<br>
							<div class="input-group">
							<button type="submit" class="btn btn-primary" style="margin-left: 200px;">Signup</button>
						</div>
						<br>
							<br>
					</form>
