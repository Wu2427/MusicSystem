...
<html lang="en">
  <head>
    ...
    <title>Music Website |歌手列表</title>
  ...
  <body>
		...
		<div class="top-nav">
			...
			<ul class="w3l">
				...
				<li><a  class="active" href="<%=basePath%>singer/getAllSinger"><i
		...
		<div class="container">
			<table class="table table-striped table-hover" style="width: 780px; margin-left: auto;margin-right: auto;" >
				...
				<c:forEach items="${singerList}" var="singer">
					<tr>
						<td><a href="<%=basePath%>singer/selectOneSinger?singerid=${singer.singerid}">${singer.singername }</a></td>
					</tr>				
				</c:forEach>
			</c:if>
				</table>
			...
			<div class="clearfix"></div> 
			<nav>
				<ul class="pagination w3-agileits-paging" style="margin-left: 400px;">
					<li class="disabled" >
