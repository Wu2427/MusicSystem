...
<html lang="en">
  <head>
    ...
    <title>Music Website |所有歌单列表</title>
...
<script type="text/javascript">
  ...
  <body>
	...
	<div class="albums agile-blog">
		<div class="container">
			<table class="table table-striped table-hover" style="width: 580px; margin-left: auto;margin-right: auto;" >
					<tbody>
						<td>歌单标题</td>
					</tbody>
					<c:if test="${!empty listsList }">
				<c:forEach items="${listsList}" var="lists">
					<tr>
						<td><a href="<%=basePath%>songlist/getSongList?listid=${lists.listid}">${lists. listname}</a>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-play"><a></a></i></td>
					</tr>				
				</c:forEach>
			</c:if>
				</table>
