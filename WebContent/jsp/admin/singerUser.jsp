...
<head>
<base href="<%=basePath%>">
<title>Music Website |歌手管理</title>
...
<script type="text/javascript">
	function del(singerid){
		$.get("<%=basePath%>singer/delSinger?id=" + singerid,function(data){
...
<script type="text/javascript">
	function addSinger(){
		...
		form.action = "<%=basePath%>singer/addSinger";
		form.method = "post";
		form.submit();
	}
</script>
		...
		<div class="agileinfo-header">
			<div class="container">
				<div class="agile-logo">
					<h1>
						<a href="jsp/admin/adminindex.jsp"><i
							class="fa fa-music bounce bounceIn animated" aria-hidden="true"></i>
							Music</a>
					</h1>
				</div>
				<div class="agileits-w3layouts-icons">
					<div class="social-icon">
						<a href="jsp/admin/adminLogin.jsp"><i
	...
	<div class="about agileits">
		<div class="container" style="margin-top: -90px;">
			<div class="about-info">
				<div class="col-md-8 about-grids" style="margin-left: 220px">
					<div>
						<table class="table table-hover">
							<tbody>
								<td>歌手列表</td>
								<td><i class="fa fa-plus-square" data-toggle="modal" data-target="#myModal">增加</i></td>
							</tbody>
							<tr>
								<td>歌手名</td>
								<td>操作</td>
							</tr>
							<c:if test="${!empty allsinger }">
								<c:forEach items="${allsinger }" var="singer">
									<tr>
										<td><a href="<%=basePath%>singer/OneSinger?singerid=${singer.singerid}">${singer.singername }</a></td>
										<td><i class="glyphicon glyphicon-trash"><a href="javascript:del('${singer.singerid }')">删除</a></i></td>
									</tr>
								</c:forEach>
							</c:if>
						</table>
								...
								<div class="modal-content">
									...
									<form action="<%=basePath%>singer/addSinger">
										<div class="modal-body">
											歌&nbsp;手&nbsp;名 : &nbsp;&nbsp;&nbsp;<input type="text"
												name="singername" style="width: 180px;" />
										</div>
										<div class="modal-body">
											歌手编号 : <input type="text" name="singerid"
												style="width: 180px;" />
										</div>
