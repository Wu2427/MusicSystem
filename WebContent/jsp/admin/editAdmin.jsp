	...
	<div class="agileinfo-main about-top">  
		...
		<div class="top-nav">
			...
			<ul class="w3l">
				...
				<li><a class="active" href="<%=basePath%>admin/getAdmin?id=${adminid}"><i class="glyphicon glyphicon-envelope"></i><span>个人中心</span></a></li>
			</ul>
		</div>	
	</div>
	<!-- //navigation end here -->
	...
	<div class="contact">
		<div class="container">  
			<div class="col-md-10 contact-right">	
				<h2>个人设置</h2><br />
				<form action="<%=basePath%>/admin/updateAdmin?id=${adminid}" method="post"> 
					昵  称：<input type="text" name="adminname" placeholder="Name" required="" style="width: 45%;" value="${admin.adminname}"><br />
					昵  称：<input type="text" name="adminpwd" placeholder="password" required="" style="width: 45%;" value="${admin.adminpwd}"><br />
