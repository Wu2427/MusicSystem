...
<head>
 <base href="<%=basePath%>">
<title> Music Website |歌手对应的歌曲管理</title>
		...
		<div class="container" style="margin-top: -90px;">
			<div class="about-info">
				<div class="col-md-12 about-grids">
					<div>
						<table class="table table-hover" style="width: 850px;margin-left: 130px">
							<tbody>
								<td>歌曲列表</td>
								<td></td>
								<td><i class="fa fa-arrow-circle-up" data-toggle="modal" data-target="#myModal">上传</i></td>
							</tbody>
							<tr>
								<td>歌曲名</td>
								<td>歌曲地址</td>
							...
							<tr>
							<c:if test="${!empty oneSinger}">
								<c:forEach items="${oneSinger }" var="onesinger">
								<td>${onesinger.songname }</td>
								<td>${onesinger.music }</td>
								<%-- <td>${onesinger.singerid }</td> --%>
								<td>
									<a href="del:javascript('${onesinger.songid}')" class="glyphicon glyphicon-trash">删除</a><i></i>
									<a href="<%=basePath %>" class="glyphicon glyphicon-pencil">修改</a>
								</td>
								</c:forEach>
							</c:if>
							</tr>
				...
				<!-- 模态框（Modal） -->
						<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									...
									<form action="<%=basePath%>singer/addSingerSong?id=${singerid}">
										<div class="modal-body">
											歌&nbsp;曲&nbsp;名 : &nbsp;&nbsp;&nbsp;<input type="text" name="songname" style="width: 180px;"/>
										</div>
										<div class="modal-body">
											歌手编号 : <input type="text" name="singerid" style="width: 180px;" value="${singerid }"/>
										</div>
										<div class="modal-body">
			...
			<nav>
				<ul class="pagination w3-agileits-paging" style="margin-left: 420px;">
					<li class="disabled" >
